...
export const defaultStateFigureCardById = {
  populist: {
    ...
    established_power: 1,
    rules: "During Legislation: Will support the class that mobilizes the most Figures.",
    quote: '"Stare into my eyes, child, and behold: madness incarnate!"',
  },
  centrist: {
    id: "centrist",
    name: "The Centrist",
    card_type: CardType.DefaultStateFigure,
    established_power: 3,
    rules: "During Legislation: Will oppose all classes.",
    quote: '"Kissing babies, shaking hands, and drunk texting pharma lobbyists from a steakhouse toilet stall"',
  },
  opportunist: {
    id: "opportunist",
    ...
    card_type: CardType.DefaultStateFigure,
    established_power: 2,
    rules: '"During Legislation: Will oppose all classes, but will abstain from voting if a class donates $15 to the bank."',
    quote: "The chair recognizes as offensive all references to canines as ‘good boys’ or ‘very good boys.’",
  },
...
export const defaultWorkplaceCardById = {
  corner_store: {
    ...
    starting_wages: 1,
    starting_profits: 4,
    quote: '"Where to go when you want to buy iPhone cables, falafel, and condoms at 3 in the morning."',
  },
  parts_producer: {
    id: "parts_producer",
    name: "Parts Producer",
    ...
    starting_wages: 3,
    starting_profits: 12,
    quote: "Making way fewer parts but far more political photo ops than ever before.",
  },
